...
```{r, echo = FALSE, fig.fullwidth = TRUE, message = FALSE, warning = FALSE, fig.cap = "Number of samples collected per site by phylum"}
library(viridis)
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per species collected by latitude."}
all_heat <- samples
# for latitude tables
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per species collected by ice cover category."}
all_heat <- samples
# for latitude tables
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per invertebrate species collected by latitude."}
invert_heat <- filter(samples, kingdom == "Animalia")
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per invertebrate species collected by ice cover category."}
invert_heat <- filter(samples, kingdom == "Animalia")
# for ice cover heat maps 
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per algal species collected by latitude."}
...
```{r, echo = FALSE, fig.fullwidth = TRUE, warning = FALSE, message = FALSE, fig.height = 20, fig.width = 15, fig.cap = "Heat map of number of reps per algal species collected by ice cover category."}
algal_heat <- filter(samples, kingdom %in% c('Plantae', 'Chromista'))
# for ice cover heat maps 
