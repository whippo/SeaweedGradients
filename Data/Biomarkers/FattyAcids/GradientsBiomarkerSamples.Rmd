...
```
A total of `r length(all_inverts$ProjID)` invertebrate and `r length(all_algae$ProjID)` algal samples were collected\footnote{These numbers are approximate due to issues identified above.}.
